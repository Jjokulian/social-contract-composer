...
export const EXAMPLE = [
  demesne('shield', 'The shield', 'defence', 'Defensive military milli', polygon([[-50, 28], [-38, 28], [-38, 36], [-50, 36]])),
  demesne('north-west', 'North-west country', 'hearth', 'Hearth culture', polygon([...west, ...north.slice(1), [-50, 36]])),
  demesne('north-east', 'North-east country', 'seafaring', 'Seafaring culture', polygon([...east, [-38, 36], ...rev(north).slice(0, -1)])),
  demesne('south-west', 'South-west country', 'hill', 'Hill culture', polygon([[-50, 28], ...south, ...rev(west).slice(1)])),
  ...
  demesne('market-quarter', 'Market quarter', 'festive', 'Festive atmosphere', island(-41.0, 29.8, 0.7, 0.2)),
];
