...
import { lookup, serviceUnits, apply } from '../server/digest.mjs';
...
if (command === 'services') {
  ...
  console.error('usage: node tools/digest.mjs services | service <id> [--text] | lookup "<words>" [kind] | apply <digest.json>');
  process.exit(2);
}
